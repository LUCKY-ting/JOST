...
function [macro, micro, hammingloss, subsetAccuracy, precision, recall, F1score, rankingLoss,oneErr] = testEvaluate_kernel_fixed_threshold(SVsIdx,coff,SVsNum,scale, gamma)
