...
%hyperparameters for kernelized FALT
...
%%the kernel matrix was precalculated for accelerating the computing
...
fprintf(fid,'name = yeast, kernel_FALT, runTimes = %d, epoch = %d, scale = %g, eta = %g, maxIter = %d \n', times, epoch, scale, eta, maxIterNum);
...
fid1 = fopen('appendix/kernel_FALT_yeast_appendix.txt','a');
for run = 1:times
